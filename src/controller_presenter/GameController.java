...
public class GameController extends JPanel implements Runnable {
    ...
    private final Tiles tiles = new Tiles(gamePanel);  // #4
    private final Player player = new Player();
    public final Sound music = new Sound();


    private final KeyHandler keyH = new KeyHandler(this);
    public CollisionChecker collisionChecker = new CollisionChecker(gamePanel);  // #6
    public final PlayerManager playerManager = new PlayerManager(collisionChecker, keyH, gamePanel, player);

    public MessageUI mUI = new MessageUI(this, gamePanel, player);  // for on-screen messages #10
    ...
    public void setupGame () {
        AssetSetter assetSetter = new AssetSetter(gamePanel);  // for setting objects #7
        assetSetter.setObject();

//        Sound music = new Sound();  // #9,10
        music.playMusic(0);  // background music #9
